 ...
 * Permite realizar operaciones CRUD sobre conferencias a través de una API
 * REST.
 */
@RestController
...
public class ConferenciaRestController {
     ...
     *
     * @return Lista de objetos ConferenciaDTO que representan todas las
     *         conferencias.
     */
    @GetMapping
     ...
     *
     * @param conferencia Objeto ConferenciaDTO con los datos de la conferencia a
     *                    crear.
     ...
     * @param conferencia Objeto ConferenciaDTO con los datos actualizados de la
     *                    conferencia.
     * @return Respuesta HTTP con el objeto ConferenciaDTO actualizado y estado OK,
     *         o NOT_FOUND si la conferencia no existe.
     */
    @PutMapping("/{id}")
    public ResponseEntity<ConferenciaDTO> actualizarConferencia(@PathVariable Integer id,
            @RequestBody ConferenciaDTO conferencia) {
    ...
    public ResponseEntity<ConferenciaDTO> agregarArticulo(@PathVariable Integer idConferencia,
            @RequestBody Integer idArticulo) {
     ...
     * @return Respuesta HTTP con true si se eliminó con éxito y estado OK, o false
     *         y NOT_FOUND si la conferencia no existe.
     */
    @DeleteMapping("/{id}")
